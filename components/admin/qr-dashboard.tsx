      ...
      <div className="mx-auto max-w-6xl px-5 py-8">
        <div className="flex flex-wrap items-end justify-between gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-2xl bg-[#3B82F6] px-4 py-2.5 text-sm font-bold text-white hover:bg-[#2563EB]"
          >
        ...
        {showForm && (
          <form onSubmit={handleCreate} className="mt-5 rounded-[24px] border border-[#EAECEF] bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 flex gap-2">
              <button type="submit" disabled={creating} className="inline-flex items-center gap-2 rounded-2xl bg-[#3B82F6] px-5 py-2.5 text-sm font-bold text-white hover:bg-[#2563EB] disabled:opacity-60">
                  ...
                  {shops.map((s) => (
                    <tr key={s.code} onClick={() => openDetail(s.code)} className="cursor-pointer border-b border-[#F5F7FA] transition last:border-none hover:bg-[#EFF4FF]">
                      <td className="px-4 py-3.5">
                        <div className="flex items-center gap-2">
                          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#EFF4FF] text-[#3B82F6]"><Store className="h-4 w-4" /></div>
                          <div>
...
function QrBox({ link, download }: { link: string; download: string }) {
  ...
  useEffect(() => {
    let active = true;
    QRCode.toDataURL(link, { width: 220, margin: 1, color: { dark: "#0B1E4D", light: "#FFFFFF" } })
      .then((url) => {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      {dataUrl && (
        <a href={dataUrl} download={download} className="inline-flex items-center gap-1.5 rounded-lg bg-[#3B82F6] px-3 py-1.5 text-xs font-bold text-white hover:bg-[#2563EB]">
  ...
  return (
    <div className="flex items-center justify-between gap-2 rounded-lg bg-[#F5F8FB] px-3 py-2">
      ...
      <button
        ...
        className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white text-[#3B82F6] ring-1 ring-[#E5E7EB] hover:bg-[#EFF4FF]"
      >
...
function ShopEditor({
  ...
  return (
    <form onSubmit={save} className="rounded-2xl border border-[#EAECEF] bg-white p-4">
      ...
      <button disabled={saving} className="mt-3 rounded-xl bg-[#3B82F6] px-4 py-2 text-sm font-bold text-white hover:bg-[#2563EB] disabled:opacity-60">
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        dir={dir}
        type={type || "text"}
        className="h-10 w-full rounded-xl border border-[#E5E7EB] bg-white px-3 text-sm outline-none focus:border-[#3B82F6]"
      />
    </label>
  );
}
...
const INPUT =
  "h-11 w-full rounded-xl border border-[#E5E7EB] bg-[#FAFBFC] px-3 text-sm text-[#1F2937] outline-none transition focus:border-[#3B82F6] focus:bg-white";
