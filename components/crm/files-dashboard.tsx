        ...
        <div className="rounded-[28px] border border-[#EAECEF] bg-white p-6 shadow-sm">
          <div className="grid gap-3 md:grid-cols-3">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#0F8B94] px-4 py-2 text-sm font-bold text-white disabled:opacity-60"
            >
              ...
              {files.map((file) => (
                <tr key={file.id} className="border-b border-[#F1F5F9]">
                  <td className="px-6 py-3">
                    <a href={file.fileUrl} target="_blank" rel="noreferrer" className="font-bold text-[#0F8B94] hover:underline">
                      {file.fileName}
                    </a>
                  </td>
