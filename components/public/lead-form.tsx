            ...
            {done ? (
              <div className="flex flex-col items-center py-10 text-center">
                <div className="gosol-pop flex h-16 w-16 items-center justify-center rounded-full bg-[#EFF4FF]">
                  <CheckCircle2 className="h-9 w-9 text-[#3B82F6]" />
                </div>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex w-full items-center justify-center gap-2 rounded-2xl bg-[#3B82F6] px-5 py-3.5 text-base font-bold text-white shadow-lg shadow-[#3B82F6]/30 transition duration-200 hover:-translate-y-0.5 hover:bg-[#2563EB] hover:shadow-xl active:translate-y-0 disabled:opacity-60"
                  >
                    {submitting ? (
                      <>
...
const inputClass =
  "h-12 w-full rounded-xl border border-[#E5E7EB] bg-[#FAFBFC] px-4 text-sm text-[#1F2937] outline-none transition focus:border-[#3B82F6] focus:bg-white focus:ring-2 focus:ring-[#3B82F6]/15";
